...
public class SwarmDebug extends PApplet {
...
/*=========================================
 Defines for Data
 =========================================*/
int IR0, IR1, IR2, IR3, IR4, IR5, IR6, IR7;// bar graphs   [MANUAL MAP]
int MEMS0, MEMS1, MEMS2, MEMS3;            // bar graphs   [MANUAL MAP]
int LDR;                                   //graphed
boolean ES0, ES1, ES2, ES3;                // GUI graphics
int IMU_X, IMU_Y, IMU_Z;                   // bar graphs   [MANUAL MAP]
int TEMP, CURR, RSSI, VOL0, VOL1;          //graphed
boolean BS0, BS1, BS2, BS3;                // GUI graphics 
boolean DP0, DP1, DP2, DP3;                // switche graphics

//define input ranges
public static final float raw_ir_min      = 1200.0f;
public static final float raw_ir_max      = 4500.0f;
public static final float raw_mems_min    = 0.0f;
public static final float raw_mems_max    = 6000.0f;
public static final float raw_ldr_min     = 0.0f;
public static final float raw_ldr_max     = 6000.0f;
public static final float raw_temp_min    = 0.0f;
public static final float raw_temp_max    = 6000.0f;
public static final float raw_rssi_min    = 0.0f;
public static final float raw_rssi_max    = 6000.0f;
public static final float raw_cur_min     = 0.0f;
public static final float raw_cur_max     = 6000.0f;
public static final float raw_vol_min     = 0.0f;
public static final float raw_vol_max     = 7600.0f;
public static final float raw_imu_min     = 0.0f;
public static final float raw_imu_max     = 7600.0f;

//define scaled output ranges for graphs
public static final float prt_ldr_min     = 0.0f;
public static final float prt_ldr_max     = 100.0f;
public static final float prt_temp_min     = 0.0f;
public static final float prt_temp_max     = 140.0f;
public static final float prt_cur_min     = 0.0f;
public static final float prt_cur_max     = 200.0f;
public static final float prt_rssi_min     = 0.0f;
public static final float prt_rssi_max     = 100.0f;
public static final float prt_ir_min     = 0.0f;
public static final float prt_ir_max     = 130.0f;
public static final float prt_mems_min     = -60.0f;
public static final float prt_mems_max     = 0.0f;
public static final float prt_vol_min      = 2.7f;
public static final float prt_vol_max      = 4.3f;
public static final float prt_imu_min      = -100.0f;
public static final float prt_imu_max      = 100.0f;
...
public void connectSwarm(int serialDevice) {
  if (serialDevice < 0 || Serial.list().length <= serialDevice) {
    ...
    try {
      if (comPort != null) comPort.stop();
      comPort = new Serial(this, Serial.list()[serialDevice], baudrate, 'N', 8, 1.0f);
...
public void useAutoConnect(float[] a) {
  autoConnectSerial = (a[0] == 1.0f);
}
...
public void parseSerialFrame() {
  //time to dig into serialBuffer
  //lots of bit shifting to get things where they need to go
  ...
  //Begin manual mapping of values
  //IR mapping
  IR0 = (int)map((float)IR0, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR1 = (int)map((float)IR1, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR2 = (int)map((float)IR2, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR3 = (int)map((float)IR3, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR4 = (int)map((float)IR4, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR5 = (int)map((float)IR5, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR6 = (int)map((float)IR6, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  IR7 = (int)map((float)IR7, raw_ir_min, raw_ir_max, prt_ir_min, prt_ir_max);
  
  //MEMS mapping
  MEMS0 = (int)map((float)MEMS0, raw_mems_min, raw_mems_max, prt_mems_min, prt_mems_max);
  MEMS1 = (int)map((float)MEMS1, raw_mems_min, raw_mems_max, prt_mems_min, prt_mems_max);
  MEMS2 = (int)map((float)MEMS2, raw_mems_min, raw_mems_max, prt_mems_min, prt_mems_max);
  MEMS3 = (int)map((float)MEMS3, raw_mems_min, raw_mems_max, prt_mems_min, prt_mems_max);
  
  //IMU mapping
  IMU_X = (int)map((float)IMU_X, raw_imu_min, raw_imu_max, prt_imu_min, prt_imu_max);
  IMU_Y = (int)map((float)IMU_Y, raw_imu_min, raw_imu_max, prt_imu_min, prt_imu_max);
  IMU_Z = (int)map((float)IMU_Z, raw_imu_min, raw_imu_max, prt_imu_min, prt_imu_max);
  
  //All other mappings occur in the graphinc equations!
}

//handles all incoming serial and breaks it up into packets
//full packets are dumped into serialBuffer and are processed later
public void readSerial() {
  if ( foundSerial && comPort != null && comPort.available() != 0) {
    //packet frame deteciton buffer...
...
//self-calling timer for reading serial async. from draw buffer
public void _readSerial() {
  readSerial();
  //check for device connectivity
  Runnable task = new Runnable() {
    public void run() {
...
//ability to write serial commands
public void _sendSerial(String toSend) {
  if (foundSerial) {
...
public void setupGraphics() {
  ...
  int dp_x = 20; int dp_y = 50; 
  cp5.addToggle("DP0")
     .setPosition(dp_x, dp_y)
     .setSize(50,20)
     .setValue(false)
     .lock()
  ...
  cp5.addSlider("MEMS0")
     ...
     .setSize(450, 20)
     .setPosition(dp_x, dp_y)
     .setRange(prt_mems_min, prt_mems_max)
     ;   
  cp5.addSlider("MEMS1")
     .lock()
     .setSize(450, 20)
  ...
  cp5.addSlider("MEMS3")
   ...
   cp5.addSlider("IMU_X")
     ...
     .setSize(30, 200)
     .setPosition(dp_x, dp_y)
     .setRange(prt_imu_min, prt_imu_max)
     ;
   cp5.addSlider("IMU_Y")
     .lock()
     .setSize(30, 200)
     .setPosition(dp_x + 90, dp_y)
     .setRange(prt_imu_min, prt_imu_max)
     ; 
   cp5.addSlider("IMU_Z")
     .lock()
     .setSize(30, 200)
     .setPosition(dp_x + 180, dp_y)
     .setRange(prt_imu_min, prt_imu_max)
     ;
  ...
  cp5.addSlider("IR0")
     ...
     .setSize(30, 200)
     .setPosition(dp_x, dp_y)
     .setRange(prt_ir_min, prt_ir_max)
     ;
  dp_x += 60;
  cp5.addSlider("IR1")
     .lock()
...
public void draw() {
  ...
  text("Recieved: " + (serialBtyesRec / 1000.0f) + " KB", 975, 795);
  text("Packets: " + ((packetNumber-1) / 1000.0f) + " kP", 975, 815);
  text("Dropped: " + (droppedPackets / 1000.0f) + " kP", 975, 835);
  if (packetNumber == 1) text("PDR: 100%", 975, 875);
  else text("PDR: " + (((packetNumber-droppedPackets-1)*1.0f)/((packetNumber-1)*1.0f)*100) + "%", 975, 875);
  if (inPacket) {
    text("Read State: Recv", 975, 855);
  } else {
    text("Read State: Idle", 975, 855);
  }
  text(currentSerialDevice + " @ " + (baudrate / 1000.0f) + " KBaud", 975, 755);
  ...
  text("Edge", 110, 40);
  text("Bump", 200, 40);
  text("MEMS SPL Levels", 290, 40);
  text("IMU Rotational Velocity", 30, 260);
  text("IR Sensor Distances", 285, 260);
  text("MEMS SPL Levels", 290, 40);
  
  text("Robot Control", 20, 525);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SwarmDebug" };
    if (passedArgs != null) {

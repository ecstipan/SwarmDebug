...
public static final float raw_imu_min     = 0.0;
public static final float raw_imu_max     = 7600.0;
...
public static final float prt_mems_min     = -60.0;
public static final float prt_mems_max     = 0.0;
public static final float prt_vol_min      = 2.7;
public static final float prt_vol_max      = 4.3;
public static final float prt_imu_min      = -100.0;
public static final float prt_imu_max      = 100.0;
